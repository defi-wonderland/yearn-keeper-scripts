...
export class MempoolBroadcastor {
	...
	private readonly doStaticCall: boolean

	// TODO: add doStaticCall to other broadcastors (KMC-206)
	constructor(provider: providers.JsonRpcProvider | providers.WebSocketProvider, gasLimit: number, doStaticCall: boolean = true) {
